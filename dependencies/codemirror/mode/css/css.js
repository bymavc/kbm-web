...
CodeMirror.defineMode("css", function(config, parserConfig) {
  if (!parserConfig.propertyKeywords) parserConfig = CodeMirror.resolveMode("text/app-content");
  ...
  var valueKeywords_ = [
    ...
    "menulist-textfield", "menutext", "information-box", "middle", "min-intrinsic",
  ...
  CodeMirror.defineMIME("text/app-content", {
